/**
 * Scolia Social API v1.2 – typer vi bruker i simulator/server.
...
export type TakeoutStartedPayload = { time?: string }; // ISO 8601
export type TakeoutFinishedPayload = { falseTakeout?: boolean; time?: string }; // ISO 8601
